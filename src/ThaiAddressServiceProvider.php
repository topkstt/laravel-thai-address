...
use TopKSTT\ThaiAddress\Contracts\District as DistrictContract;
use TopKSTT\ThaiAddress\Contracts\Province as ProvinceContract;
use TopKSTT\ThaiAddress\Contracts\PostalCode as PostalCodeContract;
    ...
    public function boot()
    {
        if ($this->app instanceof LaravelApplication) {
            ...
            if (! class_exists('ThaiAddressTablesSeeder')) {
                $this->publishes([
                    __DIR__ . '/../database/seeders/ThaiAddressTablesSeeder.php.stub' => $this->app->databasePath().'/seeders/ThaiAddressTablesSeeder.php',
                ], 'seeders');
            }
        }
